...
> ⚠️ **没有配置文件时插件默认禁用。** 详见[配置指南](docs/CONFIGURATION.md)了解所有选项。
...
详见[模式指南](docs/PATTERNS.md)了解自定义模式。
...
详见 [AI 检测指南](docs/AI_DETECTION.md) 了解详细设置。
...
| [模式](docs/PATTERNS.md) | 内置模式和自定义检测 |
| [AI 检测](docs/AI_DETECTION.md) | AI 驱动的检测设置 |
...
详见[故障排查指南](docs/TROUBLESHOOTING.md)了解详细解决方案。
